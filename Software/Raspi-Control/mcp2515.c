...
void mcp2515_init(void) {
    ...
    char buf_1[5] = {WRITE, CNF3, 0x07, 0xBF, 0x0F};
...
char mcp2515_send_message (struct can_message *message) {
    ...
    temp_msg[1] = message->typ>>3;
    temp_msg[2] = (((char)message->typ<<5)|(1<<EXIDE)|(char)(message->id>>16));
    temp_msg[3] = (char)(message->id>>8);
    temp_msg[4] = (message->id);
